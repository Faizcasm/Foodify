...
import Footer from '@/app/components/Footer';
import Loading from '@/app/loading';
import '@/app/styles/signup.css'; // Import the CSS file
    ...
    <>
      ...
      <div className="container">
        <div className="form-wrapper">
          <h1 className="title">Welcome to Foodify !</h1>
          <div className="dero">
            <FaGoogle color='red' size={30} cursor='pointer' />
            <FaGithub size={30} cursor='pointer' color='black' />
            <FaFacebook color='blue' cursor='pointer' size={30} />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <hr />
            <p className="para">OR</p>
            <button type="button" onClick={loginroute} className="buttonsign">Login</button>
          </form>
        </div>
      </div>
      <Footer />
